...
// echo '<hr>';
////S $transactie->MaakOver($conn, $rekening_2, $rekening);
...
<head>
	<script>
		function vindGebruiker(gn, callback) {
			...
			var params = 'action=vindGebruiker&gebruikersnaam='+gebruikersnaam;
...
<body>
    <header>
        <input type="text" id="gebruiker" placeholder="gebruikersnaam"><br>
        <input type="password" id="wachtwoord" placeholder="wachtwoord"><br>
        <input type="button" value="login" onclick="vindGebruiker()">
    </header>
